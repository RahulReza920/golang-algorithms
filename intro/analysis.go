...
// 	fmt.Println("N = 100, Number of instructions O(n^3) ::", fun3(100))
// 	fmt.Println("N = 100, Number of instructions O(n^3) ::", fun4(100))
// 	fmt.Println("N = 100, Number of instructions O(n^2) ::", fun5(100))
// 	fmt.Println("N = 100, Number of instructions O(n^2) ::", fun6(100))
// 	fmt.Println("N = 100, Number of instructions O(n) ::", fun7(100))
// 	fmt.Println("N = 100, Number of instructions O(n) ::", fun8(100))
// 	fmt.Println("N = 100, Number of instructions O(log(n)) ::", fun9(100))
// 	fmt.Println("N = 100, Number of instructions O(log(n)) ::", fun10(100))
// 	fmt.Println("N = 100, Number of instructions O(n^2) ::", fun11(100))
// 	fmt.Println("N = 100, Number of instructions O(n^(3/2)) ::", fun12(100))
